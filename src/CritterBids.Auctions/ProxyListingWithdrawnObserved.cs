...
/// that should react to an inbound <see cref="CritterBids.Contracts.Selling.ListingWithdrawn"/>.
...
/// </summary>
public sealed record ProxyListingWithdrawnObserved(Guid SagaId, Guid ListingId);
