...
|---|---|---|
| [`README.md`](./README.md) | Complete | Final status — all six phases closed. |
...
| [`synthesis.md`](./synthesis.md) | Complete | Cold-readable 15-minute overview; cites only other artifacts in this corpus. |
| [`OPEN-QUESTIONS.md`](./OPEN-QUESTIONS.md) | Closed | One entry (OQ-P2-01 — `IsProxy` plumbing). No additional stragglers surfaced through Phase 6. |
