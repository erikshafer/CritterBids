...
- [ ] **SignalR integration pattern** decided and recorded (ADR 026 — Provider + hook + TanStack Query cache bridge) once the first real hub is wired from the client; both SPAs follow it
