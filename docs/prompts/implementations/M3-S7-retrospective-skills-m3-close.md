...
- `docs/retrospectives/M2-S8-retrospective-skills-m2-close.md` *(prompt)* at `docs/prompts/implementations/M2-S8-retrospective-skills-m2-close.md` — the structural precedent for a docs-only close-out session (one commit per deliverable, session-close checklist, no build/test run)
